...
export default function LanguageForm() {
  ...
  const visible = state.visibility.language;
  ...
  const handlevisibilty = () => {
    ...
    dispatch({ type: "VISIBILITY", section: "language" });
  };

  useEffect(() => {
    console.log("certifacte state updated:", state.language);
  }, [state.language]);
  ...
  return (
    <section className="flex flex-col gap-3  p-3   transition-opacity duration-200 ">
      <div className="formheading flex justify-between items-center">
        <div className="heading font-semibold text-2xl">LANGUAGE 🎛️</div>
