...
export default function Login({setislogin}) {
  return (
    <div className='loginrap  px-6 py-6'>
      <h1 className='font-semibold text-2xl text-center'>Login</h1>
       <form className="flex flex-col">
             ...
             <div className="btnrap flex justify-center">
              ...
              <p className='text-center mt-5'>Don't have an account ? <button className='text-blue-500' onClick={()=>setislogin(false)}> Signup </button>  </p>
            </form>
    </div>
  )
}
